...
public class utils_arrays_dobles {
     public static void visualitzarArrayNotes(double [] notes){
            ...
            public static void minimArrayNotes(double [] notes){
            ...
            public static void maximArrayNotes(double [] notes){
            ...
            public static void mitjanaArrayNotes(double [] notes){
